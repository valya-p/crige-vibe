...
const Banner = () => {
    return (
        <div
            ...
            <button
                className="absolute text-[#FFFFFF] text-[20px] font-sans font-semibold bg-dark-purple rounded-[4px] py-[19px] px-[36px] top-[214px] left-[64px] sm:px-[52px] sm:top-[196px] sm:left-[95px] hover:scale-105">
                Перейти в эфир
            </button>
        </div>
    );
