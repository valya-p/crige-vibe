...
function OAuthButton() {
    ...
    return (
        <OAuth2Login
            ...
            onSuccess={onSuccess}
            onFailure={() => {}}>
            <div className="inline-flex justify-center rounded-md w-full border border-transparent bg-[#393939] hover:bg-[#3e3e3e] py-2 text-sm font-medium text-white focus:outline-none">
