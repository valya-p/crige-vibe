...
import PlaylistDropDown from './PlaylistDropDownd';
...
const Playlist = () => {
    ...
    return (
        <div className="flex-[0_0_10%] rounded-mb duration-200">
            ...
            <div
                className="flex justify-between w-[154px] mt-[9px] mb-1 font-semibold tracking-wide capitalize text-[14px] text-[#eae4e4] font-sans font-{600}">
